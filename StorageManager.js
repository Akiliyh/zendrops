...
export const loadMusicFromLocalStorage = async () => {
  try {
    ...
    if (music !== null) {
      ...
      return 'Resonance'; // Return a default value
    }
  } catch (error) {
    console.error('Error loading music from local storage:', error);
    return 'Music 1'; // Return a default value
  }
};
...
export const loadMenuSelectionFromLocalStorage = async () => {
  try {
    ...
    if (menuSelection !== null) {
      ...
      return 'shapes'; // Return a default value
    }
  } catch (error) {
...
export const loadShapeFromLocalStorage = async () => {
  try {
    ...
    if (shape !== null) {
      ...
      return 'circle'; // Return a default value
    }
  } catch (error) {
...
export const loadBackgroundFromLocalStorage = async () => {
  try {
    ...
    if (backgroundString !== null) {
      ...
      return ["#051329", "#03112f", "#030f34", "#070c38", "#0f073b"]; // Return a default value
    }
  } catch (error) {
